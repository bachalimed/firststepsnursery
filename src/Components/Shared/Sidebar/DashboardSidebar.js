...
const DashboardSidebar = () => {
  ...
  content =(
	...
	<div className={`bg-gray-900 ${open?"w-56":"w-20" } p-3 flex flex-1 flex-col min-h-screen text-white  duration-300 relative`}> 
		...
		<ul  className='pt-2 '>
			<Link to='/dashboard/'> 
				<li className={`text-grey-300 text-sm flex items-center gap-x-4 cursor-pointer p-2 hover:bg-sky-700 rounded-md `} onClick={()=> setOpen(!open)}>    
			...
			<Link to='/students/studentsParents/'> 
				...
				{open && studentsOpen && (
				<ul>						
					<Link to='/students/studentsParents/' className={location.pathname==='/students/studentsParents/'? 'text-teal-200':''}> 
					...
					<Link to='/students/admissions/'  className={location.pathname==='/students/admissions/'? 'text-teal-200':''}> 
					<li className='  text-grey-300 text-sm flex items-center gap-x-4 cursor-pointer p-2 px-5  hover:bg-sky-700 rounded-md 'onClick={()=> setOpen(!open)}>
						<span className='text-1xl block float-left'> <IoFileTrayStackedOutline/> </span>
						Admissions
					</li>
					</Link>		
					<Link to='/students/enrolments/'  className={location.pathname==='/students/enrolments/'? 'text-teal-200':''}> 
					<li className='  text-grey-300 text-sm flex items-center gap-x-4 cursor-pointer p-2 px-5  hover:bg-sky-700 rounded-md 'onClick={()=> setOpen(!open)}>
			...
			{open && academicsOpen && (<ul>						
					<Link to='/academics/schoolPlannings/'  className={location.pathname==='/academics/schoolPlannings/'? 'text-teal-200':''}> 
					<li className='  text-grey-300 text-sm flex items-center gap-x-4 cursor-pointer p-2 px-5  hover:bg-sky-700 rounded-md 'onClick={()=> setOpen(!open)}>
						<span className='text-1xl block float-left'> <MdOutlineBusinessCenter/> </span>
						School Plannings
					</li>
					</Link>		
					<Link to='/academics/nurseryPlannings/'  className={location.pathname==='/academics/nurseryPlannings/'? 'text-teal-200':''}> 
					<li className='  text-grey-300 text-sm flex items-center gap-x-4 cursor-pointer p-2 px-5  hover:bg-sky-700 rounded-md 'onClick={()=> setOpen(!open)}>
						<span className='text-1xl block float-left'> <LuSchool/> </span>
						Nursery Plannings
					</li>
					</Link>		
					<Link to='/academics/collectionDrop/'  className={location.pathname==='/academics/collectionDrop/'? 'text-teal-200':''}> 
					<li className='  text-grey-300 text-sm flex items-center gap-x-4 cursor-pointer p-2 px-5  hover:bg-sky-700 rounded-md 'onClick={()=> setOpen(!open)}>
			...
			{open && financesOpen && (<ul>						
					<Link to='/finances/invoices/'  className={location.pathname==='/finances/invoices/'? 'text-teal-200':''}> 
					<li className='  text-grey-300 text-sm flex items-center gap-x-4 cursor-pointer p-2 px-5  hover:bg-sky-700 rounded-md 'onClick={()=> setOpen(!open)}>
						<span className='text-1xl block float-left'> <LiaFileInvoiceDollarSolid/> </span>
						Invoices
					</li>
					</Link>		
					<Link to='/finances/payments/'  className={location.pathname==='/finances/payments/'? 'text-teal-200':''}> 
					<li className='  text-grey-300 text-sm flex items-center gap-x-4 cursor-pointer p-2 px-5  hover:bg-sky-700 rounded-md 'onClick={()=> setOpen(!open)}>
						<span className='text-1xl block float-left'> <GiReceiveMoney/> </span>
						Payments
					</li>
					</Link>		
					<Link to='/finances/expenses/'  className={location.pathname==='/finances/expenses/'? 'text-teal-200':''}> 
					<li className='  text-grey-300 text-sm flex items-center gap-x-4 cursor-pointer p-2 px-5  hover:bg-sky-700 rounded-md 'onClick={()=> setOpen(!open)}>
			...
			{open && hrOpen && (<ul>						
					<Link to='/hr/employees/'  className={location.pathname==='/hr/employees/'? 'text-teal-200':''}> 
					<li className='  text-grey-300 text-sm flex items-center gap-x-4 cursor-pointer p-2 px-5  hover:bg-sky-700 rounded-md 'onClick={()=> setOpen(!open)}>
						<span className='text-1xl block float-left'> <VscPerson/> </span>
						Employees
					</li>
					</Link>		
					<Link to='/hr/payroll/'  className={location.pathname==='/hr/payroll/'? 'text-teal-200':''}> 
					<li className='  text-grey-300 text-sm flex items-center gap-x-4 cursor-pointer p-2 px-5  hover:bg-sky-700 rounded-md 'onClick={()=> setOpen(!open)}>
						<span className='text-1xl block float-left'> <TbCreditCardPay/> </span>
						Payroll
					</li>
					</Link>		
					<Link to='/hr/leave/'  className={location.pathname==='/hr/leave/'? 'text-teal-200':''}> 
					<li className='  text-grey-300 text-sm flex items-center gap-x-4 cursor-pointer p-2 px-5  hover:bg-sky-700 rounded-md 'onClick={()=> setOpen(!open)}>
			...
			{open && deskOpen && (<ul>						
					<Link to='/desk/inquiries/'  className={location.pathname==='/desk/inquiries/'? 'text-teal-200':''}> 
					<li className='  text-grey-300 text-sm flex items-center gap-x-4 cursor-pointer p-2 px-5  hover:bg-sky-700 rounded-md 'onClick={()=> setOpen(!open)}>
						<span className='text-1xl block float-left'> <BsQuestionSquare/> </span>
						Inquiries
					</li>
					</Link>		
					<Link to='/desk/tasks/'  className={location.pathname==='/desk/tasks/'? 'text-teal-200':''}> 
					<li className='  text-grey-300 text-sm flex items-center gap-x-4 cursor-pointer p-2 px-5  hover:bg-sky-700 rounded-md 'onClick={()=> setOpen(!open)}>
						<span className='text-1xl block float-left'> <GrTask/> </span>
						Tasks
					</li>
					</Link>		
					<Link to='/desk/Chat/'  className={location.pathname==='/desk/Chat/'? 'text-teal-200':''}> 
					<li className='  text-grey-300 text-sm flex items-center gap-x-4 cursor-pointer p-2 px-5  hover:bg-sky-700 rounded-md 'onClick={()=> setOpen(!open)}>
						<span className='text-1xl block float-left'> <HiOutlineChatAlt/> </span>
						Chat
					</li>
					</Link>		
					<Link to='/desk/mails/'  className={location.pathname==='/desk/mails/'? 'text-teal-200':''}> 
					<li className='  text-grey-300 text-sm flex items-center gap-x-4 cursor-pointer p-2 px-5  hover:bg-sky-700 rounded-md 'onClick={()=> setOpen(!open)}>
			...
			<Link to='/cms/'> 
				...
				<span className={`text-base font-light flex-1 ${!open && "hidden"} duration-200`} > CMS</span>
				</li >
			</Link>
			<Link to='/public/'> 
				<li className={`text-grey-300 text-sm flex items-center gap-x-4 cursor-pointer p-2 hover:bg-sky-700 rounded-md `}onClick={()=> setOpen(!open)}>    
			...
			{open && settingsOpen && (<ul>						
					<Link to='/settings/dashboardSet/'  className={location.pathname==='/settings/dashboardSet/'? 'text-teal-200':''}> 
					<li className='  text-grey-300 text-sm flex items-center gap-x-4 cursor-pointer p-2 px-5  hover:bg-sky-700 rounded-md 'onClick={()=> setOpen(!open)}>
						<span className='text-1xl block float-left'> <VscDashboard/> </span>
						Dashboard
					</li>
					</Link>		
					<Link to='/settings/studentsSet/'  className={location.pathname==='/settings/studentsSet/'? 'text-teal-200':''}> 
					<li className='  text-grey-300 text-sm flex items-center gap-x-4 cursor-pointer p-2 px-5  hover:bg-sky-700 rounded-md 'onClick={()=> setOpen(!open)}>
						<span className='text-1xl block float-left'> <PiStudent/> </span>
						Students
					</li>
					</Link>		
					<Link to='/settings/academicsSet/'  className={location.pathname==='/settings/academicsSet/'? 'text-teal-200':''}> 
					<li className='  text-grey-300 text-sm flex items-center gap-x-4 cursor-pointer p-2 px-5  hover:bg-sky-700 rounded-md 'onClick={()=> setOpen(!open)}>
						<span className='text-1xl block float-left'> <IoSchoolOutline/> </span>
						Academics
					</li>
					</Link>		
					<Link to='/settings/financesSet/'  className={location.pathname==='/settings/financesSet/'? 'text-teal-200':''}> 
					<li className='  text-grey-300 text-sm flex items-center gap-x-4 cursor-pointer p-2 px-5  hover:bg-sky-700 rounded-md 'onClick={()=> setOpen(!open)}>
						<span className='text-1xl block float-left'> <LiaFileInvoiceDollarSolid/> </span>
						Finances
					</li>
					</Link>		
					<Link to='/settings/HRSet/'  className={location.pathname==='/settings/HRSet/'? 'text-teal-200':''}> 
					<li className='  text-grey-300 text-sm flex items-center gap-x-4 cursor-pointer p-2 px-5  hover:bg-sky-700 rounded-md 'onClick={()=> setOpen(!open)}>
						<span className='text-1xl block float-left'> <GiHumanPyramid/> </span>
						HR
					</li>
					</Link>		
					<Link to='/settings/deskSet/'  className={location.pathname==='/settings/deskSet/'? 'text-teal-200':''}> 
					<li className='  text-grey-300 text-sm flex items-center gap-x-4 cursor-pointer p-2 px-5  hover:bg-sky-700 rounded-md 'onClick={()=> setOpen(!open)}>
						<span className='text-1xl block float-left'> <FaMailBulk/> </span>
						Desk
					</li>
					</Link>		
					<Link to='/settings/cmsSet/'  className={location.pathname==='/settings/cmsSet/'? 'text-teal-200':''}> 
					<li className='  text-grey-300 text-sm flex items-center gap-x-4 cursor-pointer p-2 px-5  hover:bg-sky-700 rounded-md 'onClick={()=> setOpen(!open)}>
