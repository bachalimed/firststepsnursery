...
import {academicYearSelected,  setAcademicYears, selectCurrentAcademicYearId } from '../features/AppSettings/AcademicsSet/AcademicYears/academicYearsSlice'
...
export const selectCurrentAcademicYear = createSelector(
  [selectAllAcademicYears, (state) => state.academicYear.selectedAcademicYearId],
  (academicYears, selectedId) => academicYears.find((year) => year.id === selectedId)
);
