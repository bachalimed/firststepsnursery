...
export const apiSlice = createApi({
    ...
    tagTypes: ['student', 'user', 'family', 'task', 'employee', 'session', 'academicYear', 'studentDocument', 'studentDocumentsList', 'employeeDocument', 'employeeDocumentsList', 'service'],//will be used for cached data so when we invalidate data, it will updated
