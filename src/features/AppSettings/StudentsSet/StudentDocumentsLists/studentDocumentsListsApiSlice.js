...
export const studentDocumentsListsApiSlice = apiSlice.injectEndpoints({
    //define endpoints
    endpoints: builder => ({//a hook will be created automatically based on the end point :getstudentDocumentsLists
        getStudentDocumentsLists: builder.query({
            ...
            transformResponse: responseData => {
                const newLoadedStudentDocumentsLists = responseData.map(studentDocumentsList => { 
        ...
        getStudentDocumentsByYearById: builder.query({//will get the list for that year and append studtn document id if exisits
            query: (params) =>{
...
export const selectStudentDocumentsListsResult = studentDocumentsListsApiSlice.endpoints.getStudentDocumentsLists.select()
...
} = studentDocumentsListsAdapter.getSelectors(state => selectStudentDocumentsListsData(state) ?? initialState)