...
<form lassName="form bg-gray-100 p-6 rounded shadow-lg max-w-md mx-auto" onSubmit={onSaveStudentDocumentsListClicked}>
    <div className="form__title-row mb-4">
        <h2 className="text-xl font-semibold">New StudentDocumentsList Form</h2>
    </div>
    <div className="mb-4">
