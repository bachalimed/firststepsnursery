...
const NewPayeeForm = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    payeeWorkHistory: [],
    payeeIsActive: false,
    payeeYears: [{ academicYear: selectedAcademicYear?.title }],
  ...
  useEffect(() => {
    setValidity((prev) => ({
      ...
      validJoinDate: DATE_REGEX.test(
        formData.payeeCurrentEmployment.joinDate
      ),
  ...
  const handleWorkHistoryChange = (index, field, value) => {
    const updatedWorkHistory = [...formData.payeeWorkHistory];
  ...
  const handleRemoveWorkHistory = (index) => {
    setFormData((prev) => ({
      ...prev,
      payeeWorkHistory: prev.payeeWorkHistory.filter(
        (_, i) => i !== index
      ),
    }));
  };
    ...
    <>
      ...
      <section className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md">
        ...
        <div>
          ...
          {formData.payeeYears.map((year, index) => (
          ...
          <div className="flex items-center mb-2">
            ...
            <label
              ...
              className="ml-2 text-sm font-medium text-gray-700"
            >
              Payee IsActive {validity.validPayeeIsActive && "*"}
            </label>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                type="date"
                name="joinDate"
                value={formData.payeeCurrentEmployment.joinDate}
                onChange={(e) =>
                  setFormData((prev) => ({
                    ...prev,
                    payeeCurrentEmployment: {
