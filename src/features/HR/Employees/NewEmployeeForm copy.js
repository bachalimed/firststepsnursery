...
useEffect(()=>{
setSalaryPackage({basic:basic, cnss:cnss, other:other, payment:payment})},
[basic, cnss, other, payment])

useEffect(()=>{
setCurrentSalaryPackage({currentBasic:currentBasic, currentCnss:currentCnss, currentOther:currentOther, currentPayment:currentPayment})},
[basic, cnss, other, payment])

useEffect(()=>{
setEmployeeCurrentEmployment({currentPosition:currentPosition, joinDate:joinDate, currentContractType:contractType, currentSalaryPackage:currentSalaryPackage})},
...
//to check if we can save before onsave, if every one is true, and also if we are not loading status
    const canSave = [validUserFirstName, validUserLastName, validUsername, validPassword, validUserDob, userSex, validStreet, validCity,  validPrimaryPhone, currentPosition, joinDate, currentContractType, currentPayment,
		currentBasic, institution, fromDate, toDate, position, contractType, basic, userRoles.length ].every(Boolean) && !isEmployeeLoading
