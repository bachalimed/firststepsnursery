...
const employeesSlice = createSlice({
    ...
    reducers: {
        setEmployees: (state, action) => {//get and sort the items
            employeesAdapter.setAll(state, action.payload)
        
        },   
        setSomeEmployees: (state, action) => {employeesAdapter.upsertMany(state, action.payload)
...
//export actions
export const { setEmployees, updateEmployee,   setResult, setSomeEmployees } = employeesSlice.actions//to be used with dispatch in the components
