...
//  }
    ...
    const [username, setUsername] = useState(mother?.username || generateRandomUsername());
    ...
    const [userFullName, setUserFullName] = useState(mother?.userFullName || { userFirstName: '', userMiddleName: '', userLastName: '' });
    const [userFirstName, setUserFirstName] = useState(mother?.userFullName?.userFirstName || '');
    const [userMiddleName, setUserMiddleName] = useState(mother?.userFullName?.userMiddleName || '');
    const [userLastName, setUserLastName] = useState(mother?.userFullName?.userLastName || '');
    const [userDob, setUserDob] = useState(mother?.userDob || '');
    const [userSex, setUserSex] = useState(mother?.userSex || 'Female');
    const [userIsActive, setUserIsActive] = useState(mother?.userIsActive || false);
    ...
    const [primaryPhone, setPrimaryPhone] = useState(mother?.userContact?.primaryPhone || '');
    const [secondaryPhone, setSecondaryPhone] = useState(mother?.userContact?.secondaryPhone || '');
...
useEffect(()=>{
setMother({ username:username, password:password,  userFullName:userFullName, userDob:userDob, userSex:userSex,  userIsActive:userIsActive, userRoles:userRoles,
