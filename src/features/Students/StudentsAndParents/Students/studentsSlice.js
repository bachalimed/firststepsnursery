...
//export actions
export const { setStudents, updateStudent, setResult, setSomeStudents } =
  studentsSlice.actions; //to be used with dispatch in the components
