  ...
  endpoints: (builder) => ({
    getStudentDocuments: builder.query({
      ...
      transformResponse: (responseData) => {
        const newLoadedStudentDocuments = responseData.map(
          (studentDocument) => {
        ...
        return studentDocumentsAdapter.upsertMany(
          initialState,
          newLoadedStudentDocuments
        );
      },
    ...
    getStudentDocumentsByYear: builder.query({
      ...
      transformResponse: (responseData) => {
        ...
        return studentDocumentsAdapter.setAll(
          initialState,
          newLoadedStudentDocuments
        );
      },
...
export const selectStudentDocumentsResult =
  studentDocumentsApiSlice.endpoints.getStudentDocumentsByYear.select();
...
const selectStudentDocumentsData = createSelector(
  selectStudentDocumentsResult,
...
} = studentDocumentsAdapter.getSelectors(
  (state) => selectStudentDocumentsData(state) ?? initialState
);
