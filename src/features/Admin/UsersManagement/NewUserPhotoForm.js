...
const NewUserPhotoForm = () => {//an add user function that can be called inside the component

    const [addNewUserPhoto, {//an object that calls the status when we execute the newUserForm function
        isLoading,
        isSuccess,
        isError,
        error
    ...
    const onSavePhotoClicked = async (e) => {
        ...
        if (userPhoto) {//if cansave is true
