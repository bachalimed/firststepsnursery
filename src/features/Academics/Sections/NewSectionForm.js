...
console.log(selectedAcademicYear.title,'selectedAcademicYear')
  ...
  const [formData, setFormData] = useState({
    ...
    sectionYears: [{ academicYear: selectedAcademicYear?.title }],
    sectionCurrentEmployment: {
      position: "",
      joinDate: "",
      contractType: "",
      salaryPackage: {
  ...
  useEffect(() => {
    setValidity((prev) => ({
      ...
      validCurrentPosition: USER_REGEX.test(
        formData.sectionCurrentEmployment.position
      ),
      validJoinDate: DOB_REGEX.test(
        formData.sectionCurrentEmployment.joinDate
      ),
      validContractType: USER_REGEX.test(
        formData.sectionCurrentEmployment.contractType
      ),
      validBasic: NUMBER_REGEX.test(
        formData.sectionCurrentEmployment.salaryPackage.basic
      ),
      validPayment: NAME_REGEX.test(
        formData.sectionCurrentEmployment.salaryPackage.payment
      ),
      validSectionYear: YEAR_REGEX.test(
        formData.sectionYears[0].academicYear
      ),
    }));
  }, [formData]);
  ...
  const onAcademicYearChanged = (e, index) => {
    ...
    setFormData((prev) => {
      const updatedYears = [...prev.sectionYears];
      // Update based on checked state
      updatedYears[index].academicYear = checked ? selectedAcademicYear?.title : "";
      return { ...prev, sectionYears: updatedYears };
    });
  };

  const handleWorkHistoryChange = (index, field, value) => {
    const updatedWorkHistory = [...formData.sectionWorkHistory];
    updatedWorkHistory[index][field] = value;
    setFormData((prev) => ({
      ...prev,
      sectionWorkHistory: updatedWorkHistory,
    }));
  };
  ...
  const handleRemoveWorkHistory = (index) => {
    setFormData((prev) => ({
      ...prev,
      sectionWorkHistory: prev.sectionWorkHistory.filter(
        (_, i) => i !== index
      ),
    }));
  };
    ...
    <>
      ...
      <section className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md">
        ...
        <div>
          ...
          {/* Section Years Selection */}
          {formData.sectionYears.map((year, index) => (
            <div key={index} className="flex items-center mb-2">
              <input
                type="checkbox"
                id={`sectionYear-${index}`}
          ...
          <div className="flex items-center mb-2">
            <input
              type="checkbox"
              id="sectionIsActive"
              name="sectionIsActive"
              checked={formData.sectionIsActive === true}
              onChange={(e) => {
                setFormData((prev) => ({
                  ...prev,
                  sectionIsActive: e.target.checked,
                }));
              }}
              className='h-4 w-4  "text-blue-600"  focus:ring-blue-500 border-gray-300 rounded'
            />
            ...
            <label
              ...
              className="ml-2 text-sm font-medium text-gray-700"
            >
              Section IsActive {validity.validSectionIsActive && "*"}
            </label>
          </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                type="text"
                name="position"
                value={formData.sectionCurrentEmployment.position}
                onChange={(e) =>
                  setFormData((prev) => ({
                    ...prev,
                    sectionCurrentEmployment: {
                      ...prev.sectionCurrentEmployment,
            ...
            <div>
              ...
              <input
                type="date"
                name="joinDate"
                value={formData.sectionCurrentEmployment.joinDate}
                onChange={(e) =>
                  setFormData((prev) => ({
                    ...prev,
                    sectionCurrentEmployment: {
            ...
            <div>
              ...
              <input
                type="text"
                name="contractType"
                value={formData.sectionCurrentEmployment.contractType}
                onChange={(e) =>
                  setFormData((prev) => ({
                    ...prev,
                    sectionCurrentEmployment: {
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    onChange={(e) =>
                      setFormData((prev) => ({
                        ...
                        sectionCurrentEmployment: {
                          ...prev.sectionCurrentEmployment,
                          salaryPackage: {
                            ...prev.sectionCurrentEmployment.salaryPackage,
                ...
                <div>
                  ...
                  <input
                    ...
                    name="cnss"
                    value={
                      formData.sectionCurrentEmployment.salaryPackage.cnss
                    }
                    onChange={(e) =>
                      setFormData((prev) => ({
                        ...prev,
                ...
                <div>
                  ...
                  <input
                    ...
                    name="other"
                    value={
                      formData.sectionCurrentEmployment.salaryPackage.other
                    }
                    onChange={(e) =>
                      setFormData((prev) => ({
                        ...prev,
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold">Section Work History</h3>
            {formData.sectionWorkHistory.map((work, index) => (
              <div
                key={index}
          ...
          <div className="flex justify-end gap-4">
            <button
              type="button"
              onClick={() => navigate("/hr/sections/sections/")}
