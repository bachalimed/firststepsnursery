...
import {studentssList} from './studentssList'
import {sessionssList} from './sessionssList'
import {studentSectionss} from './studentSectionss'
...
const SectionsPlannings = () => {
  ...
  // ActionBegin handler to log data when creating a new event
  const onActionBegin = (args) => {
    if (args.requestType === "eventCreate" && args.data) {
      console.log("Data entered in creation window:", args.data);
    }
  };
  ...
  // console.log(attendedSchoolsList, "attendedSchoolsList");
  ...
  const data = extend([], sessionssList, null, true);
          ...
          <div className="col-lg-12 control-section">
            <div className="control-wrapper">
              ...
              // popupOpen={onPopupOpen}
               //actionBegin={onActionBegin} // Attach the handler here
