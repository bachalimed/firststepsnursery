...
export const animatorsAssignmentsApiSlice = apiSlice.injectEndpoints({
    //define endpoints
    endpoints: builder => ({//a hook will be created automatically based on the end point :getanimatorsAssignments
        getAnimatorsAssignments: builder.query({
            query: () => '/academics/plannings/animatorsAssignments/',//this route is as defined in the backend server.js to give all animatorsAssignments
            ...
            transformResponse: responseData => {
                ...
                return animatorsAssignmentsAdapter.upsertMany(initialState, newLoadedAnimatorsAssignments)
            },
        ...
        getAnimatorsAssignmentById: builder.query({
            query: (params) => {
              ...
              return `/academics/plannings/animatorsAssignments?${queryString}`;
            },
        ...
        addNewAnimatorsAssignment: builder.mutation({
            query: initialAnimatorsAssignmentData => ({
                url: '/academics/plannings/animatorsAssignments/',
                method: 'POST',
                body: {
...
export const selectAnimatorsAssignmentsResult = animatorsAssignmentsApiSlice.endpoints.getAnimatorsAssignments.select()
...
} = animatorsAssignmentsAdapter.getSelectors(state => selectAnimatorsAssignmentsData(state) ?? initialState)