...
const Login = () => {
    ...
    useEffect(() => {//clears out the serrormessage when username or password changes
        setErrMsg('');
    }, [username, password])
            ...
            <main className="login">
                ...
                <form className="form" onSubmit={handleSubmit}>
                    ...
                    <input
                        ...
                        required
                    />
                    <button className="form__submit-button">Sign In</button>{/*no need to set the type=submit because it is the only button */}
